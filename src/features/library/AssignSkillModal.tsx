...
export const AssignSkillModal: React.FC<AssignSkillModalProps> = ({ skill, isOpen, onClose }) => {
    const { deploySkill } = useLibraryStore();
            ...
            <div className="bg-wardian-bg border border-wardian-border rounded-xl w-full max-w-md flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-5 flex flex-col gap-4">
                    <div className="flex flex-col gap-1">
                        <label className="text-xs font-bold text-muted uppercase tracking-widest">Target Scope</label>
                        <select 
                            value={targetType}
                    ...
                    {targetType === 'class' && (
                        <div className="flex flex-col gap-1 animate-in slide-in-from-top-2 duration-200">
                            <label className="text-xs font-bold text-muted uppercase tracking-widest">Select Class</label>
                            <select 
