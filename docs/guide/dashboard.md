...
Dashboard is a singleton surface. Opening it again focuses its existing tab instead of creating a duplicate. You can move that tab between panes or keep it beside Inbox or an agent session.
