...
Spec 023 injects `WARDIAN_SESSION_ID=<uuid>` into the environment of every spawned agent. The CLI uses this as its "who am I?" signal:
...
- `docs/specs/024-wardian-cli-and-agent-command.md` (this document).
